...
class AppUpdater(private val activity: Activity) {
    ...
    private companion object {
        ...
        const val RELEASE_URL = "https://$RELEASE_HOST/repos/hojjatrad/RedFox/releases/latest"
        const val RELEASES_PAGE_URL = "https://github.com/hojjatrad/RedFox/releases/latest"
